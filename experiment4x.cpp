...
void DisplaySphere(double R, GLuint texture)
{
 ...
 {
// Assigning the texture coordinates of the current vertex, And then drawing the specified vertex with the Z coordinate inverted. Because the creation code only draws half a sphere, 
 ...
 void display(void)
{
  ...
  glColor3f(245/256.0,256/256.0,179/256.0);
      glTranslatef(0,-3,-10);
...
glColor3f(252/256.0,150/256.0,1/256.0); 
...
glColor3f(17/256.0,172/256.0,25/256.0);
DrawTextXY(-11,-1.5,-10,0.0020,"SPRING IN SOUTHERN HEMISPHERE");
glColor3f(0,1,0.52);
DrawTextXY(-14,-3,-10,0.0020,"AVERAGE TEMPERATURE IN INDIA: 24 C");  
	 glutSwapBuffers();
