...
int f=1;
float ex,ey,ez;
float pathvertices[61][3]={{0,4,-10},{0.5,3.986,-10},{1,3.944,-10},{1.5,3.872,-10},{2,3.771,-10},{2.5,3.636,-10},{3,3.464,-10},{3.5,3.248,-10},
{4,2.981,-10},{4.5,2.645,-10},{5,2.211,-10},{5.5,1.598,-10},{5.75,1.142,-10},{5.875,0.8122,-10},{5.95,0.5153,-10},{6,0,-10},{5.95,-0.5153,-10},{5.875,-0.8122,-10},{5.75,-1.142,-10},{5.5,-1.598,-10},
{5,-2.211,-10},{4.5,-2.645,-10},{4,-2.981,-10},{3.5,-3.248,-10},
...
{-5.875,-0.8122,-10},{-5.95,-0.5153,-10},{-6,0,-10},{-5.95,0.5153,-10},{-5.875,0.8122,-10},{-5.75,1.142,-10},
{-5.5,1.598,-10},{-5,2.211,-10},{-4.5,2.645,-10},{-4,2.981,-10},{-3.5,3.248,-10},{-3,3.464,-10},{-2.5,3.636,-10},{-2,3.771,-10},{-1.5,3.872,-10}
,{-1,3.944,-10},{-0.5,3.986,-10},{0,4,-10}};
...
{
 int b;											// control which vertex to work with
 glScalef(0.0125 * R, 0.0125 * R, 0.0125 * R);  
 glRotatef(90, 1, 0, 0);                        // rotating it 
                             
 glBindTexture(GL_TEXTURE_2D, texture);     // bind the texure 
 
 glBegin(GL_TRIANGLE_STRIP);				//  to begin drawing the sphere 
...
glColor3f(0,1,0.5);
DrawTextXY(-6,4.3,0.0,0.0030,"REASON FOR");
glColor3f(0,1,0.5);
DrawTextXY(-6,3.8,0.0,0.0030," SEASONS ");
glColor3f(0,1,1);
DrawTextXY(3,4.3,0.0,0.0007," Press F for faster revolution");
glColor3f(0,1,1);
DrawTextXY(3,4,0.0,0.0007," Press r for reverse rotation");
glColor3f(0,1,1);
DrawTextXY(3,3.7,0.0,0.0007," Press R for faster rotation");
glColor3f(17/256.0,172/256.0,25/256.0);
DrawTextXY(-1,4.5,0.0,0.0010," SPRING EQUINOX ");
DrawTextXY(-1,4.3,0.0,0.0010," MARCH 21 ");
glColor3f(210/256.0,105/256.0,33/256.0);  
DrawTextXY(-1,-1.8,0.0,0.0010," AUTUMN EQUINOX ");
DrawTextXY(-1,-2,0.0,0.0010," SEPTEMBER 23 ");
glColor3f(0.9,1,1);
glColor3f(1,1,0);
DrawTextXY(-6,1.1,0.0,0.0010," SUMMER SOLSTICE ");
glColor3f(1,1,0);
DrawTextXY(-6,0.9,0.0,0.0010," JUNE 21 ");
glColor3f(0.9,1,1);
DrawTextXY(4.5,1.1,0.0,0.0010," WINTER SOLSTICE ");
glColor3f(0.9,1,1);
DrawTextXY(4.5,0.9,0.0,0.0010," DECEMBER 22 ");
...
glColor3f(0.6,0.8,0);
DrawTextXY(-3.5,0,0.0,0.001," UNDER THE GUIDENCE OF : ");
glColor3f(0.0,0.0,1.0);
DrawTextXY(-3,-0.4,0.0,0.001,"Y Shobha ");
DrawTextXY(-3,-0.6,0.0,0.001,"Associate Professor");
DrawTextXY(-3,-0.8,0.0,0.001,"Dept of CSE, BIT");
glColor3f(0,1,0);
DrawTextXY(2,-0.4,0.0,0.001,"N Thanuja ");
DrawTextXY(2,-0.6,0.0,0.001,"Assistant Professor");
DrawTextXY(2,-0.8,0.0,0.001,"Dept of CSE, BIT");
glColor3f(1.0,0.0,1.0);
DrawTextXY(1.25,-1.5,0.0,0.0015," Press i to move on... ");
glFlush();
glutSwapBuffers();
}
...
glColor3f(0/256.0,191/256.0,255/256.0);
DrawTextXY(-1.25,2.7,0.0,0.0015," 1: w to get the description ");
...
DrawTextXY(-1.25,0.9,0.0,0.0015," 7: r for reverse rotation");
DrawTextXY(-1.25,0.6,0.0,0.0015," 8: R for faster rotation");
DrawTextXY(-1.25,0.3,0.0,0.0015," 9: q to quit");
glColor3f(1.0,1.0,0);
...
case 27:exit(0);
		break;
	case 's':
			result=system("C:\\Users\\KS1\\Desktop\\pro\\experiment.exe");
			break;
		case 'w':
			result=system("C:\\Users\\KS1\\Desktop\\pro\\experiment2x.exe");
			break;		
		case 'p':
			result=system("C:\\Users\\KS1\\Desktop\\pro\\experiment4x.exe");
			break;		
		case 'a':
			result=system("C:\\Users\\KS1\\Desktop\\pro\\experiment3x.exe");
			break;	
		case 'c':k=1;
			break;
		case 'i':k=2;
...
{		
	//	PlaySound("C:\\Users\\KS1\\Desktop\\random\\178243__sclolex__spacemusic.wav",NULL,SND_SYNC);
      glutInit(&argc, argv);
      glutInitDisplayMode(GLUT_DOUBLE | GLUT_DEPTH| GLUT_BORDERLESS| GLUT_CAPTIONLESS);
